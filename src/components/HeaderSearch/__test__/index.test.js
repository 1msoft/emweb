...
describe('HeaderSearch: 头部搜索栏', () => {
  ...
  //   // 无 空 数组
  //   let wrapper = mount(
  //     <HeaderSearch searchList={null} searchRecord={null}/>
  //   );
  //   wrapper.find('.ant-input').at(0).simulate('click');

  //   wrapper = mount(
  //     <HeaderSearch searchList={null} searchRecord={[]}/>
  //   );
  //   wrapper.find('.ant-input').at(0).simulate('click');

  //   wrapper = mount(
  //     <HeaderSearch searchList={null} searchRecord={searchRecord}/>
  //   );
  //   wrapper.find('.ant-input').at(0).simulate('click');


  //   wrapper = mount(
  //     <HeaderSearch searchList={[]} searchRecord={null}/>
  //   );
  //   wrapper.find('.ant-input').at(0).simulate('click');
  //   wrapper = mount(
  //     <HeaderSearch searchList={[]} searchRecord={[]}/>
  //   );

  //   wrapper.find('.ant-input').at(0).simulate('click');
  //   wrapper = mount(
  //     <HeaderSearch searchList={[]} searchRecord={searchRecord}/>
  //   );
  //   wrapper.find('.ant-input').at(0).simulate('click');

  //   wrapper = mount(
  //     <HeaderSearch searchList={searchList} searchRecord={null}/>
  //   );
  //   wrapper.find('.ant-input').at(0).simulate('click');
  //   wrapper = mount(
  //     <HeaderSearch searchList={searchList} searchRecord={[]}/>
  //   );
  //   wrapper.find('.ant-input').at(0).simulate('click');
  //   wrapper = mount(
  //     <HeaderSearch searchList={searchList} searchRecord={searchRecord}/>
  //   );
  //   wrapper.find('.ant-input').at(0).simulate('click');
